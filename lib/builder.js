...
var QueryFilterBuilder = /** @class */ (function () {
    ...
    QueryFilterBuilder.prototype.withGreaterThanEquals = function (key, value) {
        ...
        var q = "".concat(k, ":").concat(constants_1.Operators.GTE, ":").concat(value);
        this.filters.push(q);
        return this;
    };
    QueryFilterBuilder.prototype.withGreaterThan = function (key, value) {
        var k = string_escaper_1.QueryStringEscaper.escapeSpecialChars(key);
        var q = "".concat(k, ":").concat(constants_1.Operators.GT, ":").concat(value);
        this.filters.push(q);
        return this;
    };
    QueryFilterBuilder.prototype.withLessThanEquals = function (key, value) {
        var k = string_escaper_1.QueryStringEscaper.escapeSpecialChars(key);
        var q = "".concat(k, ":").concat(constants_1.Operators.LTE, ":").concat(value);
        this.filters.push(q);
        return this;
    };
    QueryFilterBuilder.prototype.withLessThan = function (key, value) {
        var k = string_escaper_1.QueryStringEscaper.escapeSpecialChars(key);
        var q = "".concat(k, ":").concat(constants_1.Operators.LT, ":").concat(value);
        this.filters.push(q);
        return this;
    };
    ...
    QueryFilterBuilder.prototype.withContains = function (key, value) {
        var k = string_escaper_1.QueryStringEscaper.escapeSpecialChars(key);
        var q = "".concat(k, ":").concat(constants_1.Operators.CONTAINS, ":").concat(value);
        this.filters.push(q);
        return this;
    };
